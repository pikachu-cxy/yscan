...
func ParseOptions(uri goflags.StringSlice, output string, path string) *Options {
	...
	/*
		...
		flagSet.CreateGroup("input", "Input",
			flagSet.StringVarP(&options.InputFile, "list", "l", uri, "input file containing list of hosts to process"),
			flagSet.StringVarP(&options.InputRawRequest, "request", "rr", "", "file containing raw request"),
			flagSet.StringSliceVarP(&options.u , "target", "u", nil, "input target host(s) to probe", goflags.CommaSeparatedStringSliceOptions),
		)

		flagSet.CreateGroup("Probes", "Probes",
			flagSet.BoolVarP(&options.StatusCode, "status-code", "sc", true, "display response status-code"),
			...
			flagSet.BoolVar(&options.ExtractTitle, "title", true, "display page title"),
		...
		flagSet.CreateGroup("matchers", "Matchers",
			...
			flagSet.StringSliceVarP(&options.OutputMatchCdn, "match-cdn", "mcdn", nil, fmt.Sprintf("match host with specified cdn provider ()"), goflags.NormalizedStringSliceOptions),
		...
		flagSet.CreateGroup("filters", "Filters",
			...
			flagSet.StringSliceVarP(&options.OutputFilterCdn, "filter-cdn", "fcdn", nil, fmt.Sprintf("filter host with specified cdn provider ()"), goflags.NormalizedStringSliceOptions),
