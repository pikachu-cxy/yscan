	...
	for _, r := range ranges {
		...
		if strings.Contains(r, "-") {
			...
			if len(parts) != portListStrParts {
				return nil, fmt.Errorf("无效的端口参数: '%s'", r)
			}
